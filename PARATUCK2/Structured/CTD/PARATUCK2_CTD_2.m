function [Wres, D2res, Vtres, D1res, Ztres, cD1res, cD2res] = PARATUCK2_CTD_2(Jac, bf1, bf1d, bf2d, r1, r2, samples)
...
%taking into account the neural network structure.
    ...
    for i=1:3
        ...
        % Projectie strategie
        [cD1, D1] = update_cD1(cD1, D1, Zt, samples, bf1d, K, r1, d1, lambda1);
        ...
        % Projectie strategie
        [cD2, D2] = update_cD2(cD2, D2, Vt, Zt, samples, cD1, bf1, bf2d, K, r2, d2, lambda2);
...
function [cD1, D1] = update_cD1(cD1, D1, Zt, samples, bf1d, K, r1, d1, lambda1)
    % Projectiestrategie
    X = sparse(r1*K, r1*d1);
    for l=1:r1
        Xl = zeros(K, d1);
...
function [cD2, D2] = update_cD2(cD2, D2, Vt, Zt, samples, cD1, bf1, bf2d, K, r2, d2, lambda2)
    % Projectiestrategie
    X = sparse(r2*K, r2*d2);
    for l=1:r2
        Xl = zeros(K, d2);
